...
class GuidesManager(SelectTool):
	...
	def mouseDown_(self, theEvent):
		objc.super(GuidesManager, self).mouseDown_(theEvent)
		"""
	...
	def mouseDragged_(self, theEvent):
		objc.super(GuidesManager, self).mouseDragged_(theEvent)
		"""
	...
	def mouseUp_(self, theEvent):
		objc.super(GuidesManager, self).mouseUp_(theEvent)
		"""
